...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Pata.ubigeo' to match new field type.
        db.rename_column(u'aplicacion_pata', 'ubigeo', 'ubigeo_id')
        # Changing field 'Pata.ubigeo'
        db.alter_column(u'aplicacion_pata', 'ubigeo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ubigeo.Ubigeo'], null=True))
        # Adding index on 'Pata', fields ['ubigeo']
        db.create_index(u'aplicacion_pata', ['ubigeo_id'])


    def backwards(self, orm):
        # Removing index on 'Pata', fields ['ubigeo']
        db.delete_index(u'aplicacion_pata', ['ubigeo_id'])


        # User chose to not deal with backwards NULL issues for 'Pata.ubigeo'
        raise RuntimeError("Cannot reverse this migration. 'Pata.ubigeo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Renaming column for 'Pata.ubigeo' to match new field type.
        db.rename_column(u'aplicacion_pata', 'ubigeo_id', 'ubigeo')
        # Changing field 'Pata.ubigeo'
        db.alter_column(u'aplicacion_pata', 'ubigeo', self.gf('django.db.models.fields.CharField')(max_length=6))
